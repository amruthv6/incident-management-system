...
async function seed() {
  ...
  const incidents = [
    ...
    },
    {
      ...
      description: "Multiple failed login attempts detected from unknown IP addresses (182.51.xx.xx range) targeting the admin dashboard. Possible brute-force attack in progress.",
      priority: "critical",
      status: "investigating",
      category: "Security",
    ...
    },
    {
      ...
      description: "One disk in RAID-6 array SAN-PROD-02 has failed. System is operating in degraded mode. Replacement disk required before another failure causes data loss.",
      priority: "high",
      status: "resolved",
